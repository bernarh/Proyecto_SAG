							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="navbar-1">
									<ul class="nav navbar-nav">
										<li><a href="ver_datosdirector.php">Ver Datos</a></li>
										
										
										<li class="active"><a href="reportesdirector.php">Reportes</a></li>
										<li class="dropdown">
											<a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" >Gr&aacute;ficos<span class="caret"></span></a>
											<ul class="dropdown-menu">
										
                                                <li><a href="grafico_barrad.php">Gr&aacute;fico de Barras</a></li>
                                                <li><a href="grafico_linead.php">Gr&aacute;fico de Linea</a></li>
												<li class="divider"></li>
										...
										<li class="dropdown ">
											...
											<ul href="opcion" class="dropdown-menu">
												...
												<li class="divider"></li>
												<li><a href="cambiarpwd.php">Cambiar Contrase&ntilde;a</a></li>
